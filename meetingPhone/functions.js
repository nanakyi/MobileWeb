...
$(document).ready(function(){
	$("#submit").click(function()
  {
    ...
    // var poster=$('#image1').val();
      ...
      return syncAjax("meetingReq.php?cmd=1&name="+name+"&phonenumber="+phonenumber+
...
$("#signUp").click(function()
  {
    ...
    var password= $('#ePassword').val();
      ...
      return syncAjax("meetingReq.php?cmd=4&name="+name+"&username="+username+
      "&password="+password);
